...
환경변수:
  TAVILY_API_KEY    Tavily API 키 (필수, https://app.tavily.com)
    ...
    p_search.add_argument("--backend", default="auto", choices=["auto", "serpapi", "tavily"], help="검색 백엔드 선택 (SerpAPI는 구글 뉴스 전용, Tavily는 범용 검색)")
    ...
    p_collect.add_argument("--backend", default="auto", choices=["auto", "serpapi", "tavily"], help="검색 백엔드 선택 (SerpAPI는 구글 뉴스 전용, Tavily는 범용 검색)")
